...
<body>
    ...
    <div
        ...
        <div class="mdl-layout__drawer" style="overflow: auto;">
            ...
            <nav class="mdl-navigation">
                <hr style="background-color:white"><a class="mdl-navigation__link" href="patient.php"
                    style='color:#0767D1'>Patients</a>
        ...
        <main class="mdl-layout__content">
            <section class="mdl-layout__tab-panel is-active" id="fixed-tab-1">
                ...
                <div class="row">
                    ...
                    <div class="column">
                        <div class="card">
                            <h1><?php echo $rowss["opd"]; ?></h1>
                            <p class="title"><?php echo $rowss["first_name"]; ?> <?php echo $rowss["last_name"]; ?>
                            </p>
                            <p><a href="#" data-role="update" data-id="<?php echo $rowss["opd"]; ?>"><button>Edit</button></a></p>
                        </div>
                    </div>
                    <?php
                        }
                ...
                <div class="row">
                    ...
                    <div class="column">
                        <div class="card" id="<?php echo $rows["opd"]; ?>">
                            <h1 data-target="opdnumber"><?php echo $rows["opd"]; ?></h1>
                            <p class="title" data-target="name"><?php echo $rows["first_name"]; ?>
                                <?php echo $rows["last_name"]; ?>
                            </p>
                            <p><a href="#" data-role="update" data-id="<?php echo $rows["opd"]; ?>"><button>Edit</button></a></p>
                        </div>
                    </div>
                    <?php
                        endwhile;
    ...
    <section class="mdl-layout__tab-panel" id="fixed-tab-2">
        <div class="page-content">
            ...
            <div class="row">
                ...
                <div class="column">
                    <div class="card">
                        <h1><?php echo $rows["opd"]; ?></h1>
                        <p class="title"><?php echo $rows["first_name"]; ?>
                            <?php echo $rows["last_name"]; ?></p>
                        <p><a href="#" data-role="update" data-id="<?php echo $rows["opd"]; ?>"><button>Edit</button></a></p>
                    </div>
                </div>
                <?php
    ...
    function form_submit1() {
        var f_name1 = document.getElementById('f_name1').value;
        var l_name1 = document.getElementById('l_name1').value;
        var gender1 = document.getElementById('gender1').value;
        var dob1 = document.getElementById('dob1').value;
        var age1 = document.getElementById('age1').value;
        var mobile1 = document.getElementById('mobile1').value;
        var o_mobile1 = document.getElementById('o_mobile1').value;
        var add_11 = document.getElementById('add_11').value;
        var city1 = document.getElementById('city1').value;
        var state1 = document.getElementById('state1').value;
        var pin1 = document.getElementById('pin1').value;
        var digit = ('' + mobile1)[0];
        var digit1 = ('' + o_mobile1)[0];
        const getAge = birthDate => Math.floor((new Date() - new Date(birthDate).getTime()) / 3.15576e+10);
        var age_diff = getAge(dob1);

        if ((f_name1 != "") && (l_name1 != "") && (dob1 != "") && (mobile1 != "") && (o_mobile1 != "") && (add_11 != "") && (
                city1 != "") && (
                state1 != "") && (pin1 != "") && (age1 == age_diff) && ((gender1 == "Male") || (gender1 == "Female") || (gender1 == "Other"))) {
            document.getElementById("e_form").submit();
        } else {
            if ((f_name1 == "") || (f_name1.length <= 3)) {
                document.getElementById("f_name_prroblem").innerHTML = "Please Enter First Name!";
                document.getElementById("wrrong").style.visibility = "visible";
                document.getElementById("f_name1").style.borderColor = "#e74c3c";
                document.getElementById("f_name_prroblem").style.visibility = "visible";
                document.getElementById("corrrect").style.visibility = "hidden";
            } else {
                document.getElementById("corrrect").style.visibility = "visible";
                document.getElementById("f_name1").style.borderColor = "#2ecc71";
                document.getElementById("f_name_prroblem").style.visibility = "hidden";
                document.getElementById("wrrong").style.visibility = "hidden";
            }
            if ((l_name1 == "") || (l_name1.length <= 1)) {
                document.getElementById("l_name_prroblem").innerHTML = "Please Enter Last Name!";
                document.getElementById("wrrong9").style.visibility = "visible";
                document.getElementById("l_name1").style.borderColor = "#e74c3c";
                document.getElementById("l_name_prroblem").style.visibility = "visible";
                document.getElementById("corrrect9").style.visibility = "hidden";
            } else {
                document.getElementById("corrrect9").style.visibility = "visible";
                document.getElementById("l_name1").style.borderColor = "#2ecc71";
                document.getElementById("l_name_prroblem").style.visibility = "hidden";
                document.getElementById("wrrong9").style.visibility = "hidden";
            }
            if ((dob1 == "") || (age_diff < 1)) {
                document.getElementById("dob_prroblem").innerHTML = "Please Enter Valid DOB!";
                document.getElementById("wrrong1").style.visibility = "visible";
                document.getElementById("dob1").style.borderColor = "#e74c3c";
                document.getElementById("dob_prroblem").style.visibility = "visible";
                document.getElementById("corrrect1").style.visibility = "hidden";
            } else {
                document.getElementById("corrrect1").style.visibility = "visible";
                document.getElementById("dob1").style.borderColor = "#2ecc71";
                document.getElementById("dob_prroblem").style.visibility = "hidden";
                document.getElementById("wrrong1").style.visibility = "hidden";
            }
            if ((age1 == "") || (age1.length > 3) || (age1 != age_diff)) {
                document.getElementById("age_prroblem").innerHTML = "Please Enter Valid Age!";
                document.getElementById("age_prroblem").style.visibility = "visible";
                document.getElementById("wrrong2").style.visibility = "visible";
                document.getElementById("age1").style.borderColor = "#e74c3c";
                document.getElementById("corrrect2").style.visibility = "hidden";
            } else {
                document.getElementById("corrrect2").style.visibility = "visible";
                document.getElementById("age1").style.borderColor = "#2ecc71";
                document.getElementById("age_prroblem").style.visibility = "hidden";
                document.getElementById("wrrong2").style.visibility = "hidden";
            }
            if ((mobile1 == "") || (mobile1.length != 10) || (digit < 6)) {
                document.getElementById("m_prroblem").innerHTML = "Please Enter Mobile Number!";
                document.getElementById("m_prroblem").style.visibility = "visible";
                document.getElementById("wrrong3").style.visibility = "visible";
                document.getElementById("mobile1").style.borderColor = "#e74c3c";
                document.getElementById("corrrect3").style.visibility = "hidden";
            } else {
                document.getElementById("corrrect3").style.visibility = "visible";
                document.getElementById("mobile1").style.borderColor = "#2ecc71";
                document.getElementById("m_prroblem").style.visibility = "hidden";
                document.getElementById("wrrong3").style.visibility = "hidden";
            }
            if ((o_mobile1 == "") || (o_mobile1.length != 10) || (digit1 < 6)) {
                document.getElementById("om_prroblem").innerHTML = "Please Enter Optional Mobile!";
                document.getElementById("om_prroblem").style.visibility = "visible";
                document.getElementById("wrrong4").style.visibility = "visible";
                document.getElementById("o_mobile1").style.borderColor = "#e74c3c";
                document.getElementById("corrrect4").style.visibility = "hidden";
            } else {
                document.getElementById("corrrect4").style.visibility = "visible";
                document.getElementById("o_mobile1").style.borderColor = "#2ecc71";
                document.getElementById("om_prroblem").style.visibility = "hidden";
                document.getElementById("wrrong4").style.visibility = "hidden";
            }
            if (add_11 == "") {
                document.getElementById("a_prroblem").innerHTML = "Please Enter Address!";
                document.getElementById("a_prroblem").style.visibility = "visible";
                document.getElementById("wrrong5").style.visibility = "visible";
                document.getElementById("add_11").style.borderColor = "#e74c3c";
                document.getElementById("corrrect5").style.visibility = "hidden";
            } else {
                document.getElementById("corrrect5").style.visibility = "visible";
                document.getElementById("add_11").style.borderColor = "#2ecc71";
                document.getElementById("a_prroblem").style.visibility = "hidden";
                document.getElementById("wrrong5").style.visibility = "hidden";
            }
            if (city1 == "") {
                document.getElementById("c_prroblem").innerHTML = "Please Enter Address!";
                document.getElementById("c_prroblem").style.visibility = "visible";
                document.getElementById("wrrong6").style.visibility = "visible";
                document.getElementById("city1").style.borderColor = "#e74c3c";
                document.getElementById("corrrect6").style.visibility = "hidden";
            } else {
                document.getElementById("corrrect6").style.visibility = "visible";
                document.getElementById("city1").style.borderColor = "#2ecc71";
                document.getElementById("c_prroblem").style.visibility = "hidden";
                document.getElementById("wrrong6").style.visibility = "hidden";
            }
            if (state1 == "") {
                document.getElementById("s_prroblem").innerHTML = "Please Select State!";
                document.getElementById("s_prroblem").style.visibility = "visible";
                document.getElementById("wrrong7").style.visibility = "visible";
                document.getElementById("state1").style.borderColor = "#e74c3c";
                document.getElementById("corrrect7").style.visibility = "hidden";
            } else {
                document.getElementById("corrrect7").style.visibility = "visible";
                document.getElementById("state1").style.borderColor = "#2ecc71";
                document.getElementById("s_prroblem").style.visibility = "hidden";
                document.getElementById("wrrong7").style.visibility = "hidden";
            }
            if ((pin1 == "") || (pin1.length != 6)) {
                document.getElementById("p_prroblem").innerHTML = "Please Enter Pin!";
                document.getElementById("p_prroblem").style.visibility = "visible";
                document.getElementById("wrrong8").style.visibility = "visible";
                document.getElementById("pin1").style.borderColor = "#e74c3c";
                document.getElementById("corrrect8").style.visibility = "hidden";
            } else {
                document.getElementById("corrrect8").style.visibility = "visible";
                document.getElementById("pin1").style.borderColor = "#2ecc71";
                document.getElementById("p_prroblem").style.visibility = "hidden";
                document.getElementById("wrrong8").style.visibility = "hidden";
            }
            if (gender1 == "") {
                document.getElementById("gender_prroblem").innerHTML = "Please Enter Gender!";
                document.getElementById("gender_prroblem").style.visibility = "visible";
                document.getElementById("wrrong99").style.visibility = "visible";
                document.getElementById("gender1").style.borderColor = "#e74c3c";
                document.getElementById("corrrect99").style.visibility = "hidden";
            } else {
                document.getElementById("corrrect99").style.visibility = "visible";
                document.getElementById("gender1").style.borderColor = "#2ecc71";
                document.getElementById("gender_prroblem").style.visibility = "hidden";
                document.getElementById("wrrong99").style.visibility = "hidden";
            }
