...
<body>
    ...
    <header class="mdl-layout__header" style="background-color:#4481eb;">
        ...
        <div class="mdl-layout__tab-bar mdl-js-ripple-effect" style="background-color: #4481eb;">
            <a href="#fixed-tab-1" class="mdl-layout__tab is-active">Adult</a>
            <a href="#fixed-tab-2" class="mdl-layout__tab">Child</a>
        </div>
    </header>
    <div class="mdl-layout__drawer" style="overflow: auto;">
            ...
            <nav class="mdl-navigation">
                ...
                <a class="mdl-navigation__link" href="p_dental.php" style='color:#0767D1'>Dental Chart</a>
        ...
        <div class="page-content">
            ...
            <div class="table-responsive" style="padding:20px">
                <table class="table table-bordered">
                    ...
                    mysqli_select_db($con, 'doc_project');
                    $opd=$_SESSION["p_id"];
                    $commands = "select * from p_dental_treatment where opd ='$opd' and tooth_number<51";
            ...
            <g id="toothLabels">
                <text id="lbl32" transform="matrix(1 0 0 1 97.9767 402.1409)" font-family="'Avenir-Heavy'" font-size="21px">48</text>
                <text id="lbl31" transform="matrix(1 0 0 1 94.7426 449.1693)" font-family="'Avenir-Heavy'" font-size="21px">47</text>
                <text id="lbl30" transform="matrix(1 0 0 1 106.0002 495.5433)" font-family="'Avenir-Heavy'" font-size="21px">46</text>
                <text id="lbl29" transform="matrix(1 0 0 1 118.0002 538.667)" font-family="'Avenir-Heavy'" font-size="21px">45</text>
                
                    <text id="lbl28" transform="matrix(0.9999 -1.456241e-02 1.456241e-02 0.9999 136.4086 573.5098)" font-family="'Avenir-Heavy'" font-size="21px">44</text>
                <text id="lbl27" transform="matrix(1 0 0 1 157.3335 603.8164)" font-family="'Avenir-Heavy'" font-size="17px">43</text>
                <text id="lbl26" transform="matrix(1 0 0 1 179.3335 623.8164)" font-family="'Avenir-Heavy'" font-size="18px">42</text>
                <text id="lbl25" transform="matrix(1 0 0 1 204.6669 628.483)" font-family="'Avenir-Heavy'" font-size="18px">41</text>
                <text id="lbl24" transform="matrix(1 0 0 1 231.3335 628.1497)" font-family="'Avenir-Heavy'" font-size="18px">31</text>
                <text id="lbl23" transform="matrix(1 0 0 1 256.3335 619.1497)" font-family="'Avenir-Heavy'" font-size="17px">32</text>
                <text id="lbl22" transform="matrix(1 0 0 1 276.3335 602.483)" font-family="'Avenir-Heavy'" font-size="18px">33</text>
                <text id="lbl21" transform="matrix(1 0 0 1 286.6669 573.1497)" font-family="'Avenir-Heavy'" font-size="21px">34</text>
                <text id="lbl20" transform="matrix(1 0 0 1 303.6327 538.667)" font-family="'Avenir-Heavy'" font-size="21px">35</text>
                <text id="lbl19" transform="matrix(1 0 0 1 322.983 495.5432)" font-family="'Avenir-Heavy'" font-size="21px">36</text>
                <text id="lbl18" transform="matrix(1 0 0 1 325.1251 449.1686)" font-family="'Avenir-Heavy'" font-size="21px">37</text>
                <text id="lbl17" transform="matrix(1 0 0 1 324.0004 402.1405)" font-family="'Avenir-Heavy'" font-size="21px">38</text>
                <text id="lbl16" transform="matrix(1 0 0 1 312.8534 324.1021)" font-family="'Avenir-Heavy'" font-size="21px">28</text>
                <text id="lbl15" transform="matrix(1 0 0 1 315.3335 275.3333)" font-family="'Avenir-Heavy'" font-size="21px">27</text>
                <text id="lbl14" transform="matrix(1 0 0 1 311.3335 236)" font-family="'Avenir-Heavy'" font-size="21px">26</text>
                <text id="lbl13" transform="matrix(1 0 0 1 300.3335 200.6667)" font-family="'Avenir-Heavy'" font-size="21px">25</text>
                <text id="lbl12" transform="matrix(1 0 0 1 286.6669 172)" font-family="'Avenir-Heavy'" font-size="21px">24</text>
                <text id="lbl11" transform="matrix(1 0 0 1 270.2269 142.439)" font-family="'Avenir-Heavy'" font-size="21px">23</text>
                <text id="lbl10" transform="matrix(1 0 0 1 247.5099 118.9722)" font-family="'Avenir-Heavy'" font-size="21px">22</text>
                <text id="lbl9" transform="matrix(1 0 0 1 227.8432 112.9722)" font-family="'Avenir-Heavy'" font-size="21px">21</text>
                <text id="lbl8" transform="matrix(1 0 0 1 200.1766 112.9722)" font-family="'Avenir-Heavy'" font-size="21px">11</text>
                <text id="lbl7" transform="matrix(1 0 0 1 170.5099 117.6388)" font-family="'Avenir-Heavy'" font-size="21px">12</text>
                <text id="lbl6" transform="matrix(1 0 0 1 148.6667 134.167)" font-family="'Avenir-Heavy'" font-size="21px">13</text>
                <text id="lbl5" transform="matrix(1 0 0 1 131.3605 164.8335)" font-family="'Avenir-Heavy'" font-size="21px">14</text>
                <text id="lbl4" transform="matrix(1 0 0 1 119.3927 195.6387)" font-family="'Avenir-Heavy'" font-size="21px">15</text>
                <text id="lbl3" transform="matrix(1 0 0 1 103.8631 234.4391)" font-family="'Avenir-Heavy'" font-size="21px">16</text>
                <text id="lbl2" transform="matrix(1 0 0 1 96.2504 275.9999)" font-family="'Avenir-Heavy'" font-size="21px">17</text>
                <text id="lbl1" transform="matrix(1 0 0 1 93.9767 324.769)" font-family="'Avenir-Heavy'" font-size="21px">18</text>
            </g>
            <g id="dmftLabels">
                <text id="txtTooth32" transform="matrix(1 0 0 1 5.0001 386.3778)" font-family="'MyriadPro-Regular'" font-size="16px">3rd Molar</text>
                <text id="txtTooth31" transform="matrix(1 0 0 1 0.9998 449.7374)" font-family="'MyriadPro-Regular'" font-size="16px">2nd Molar</text>
                <text id="txtTooth30" transform="matrix(1 0 0 1 9.6668 513.5912)" font-family="'MyriadPro-Regular'" font-size="16px">1st Molar</text>
                <text id="txtTooth29" transform="matrix(1 0 0 1 36.3335 578.2579)" font-family="'MyriadPro-Regular'" font-size="16px">2nd Bicuspid</text>
                <text id="txtTooth28" transform="matrix(1 0 0 1 74.3335 626.9246)" font-family="'MyriadPro-Regular'" font-size="16px">1st Biscuspid</text>
                <text id="txtTooth27" transform="matrix(1 0 0 1 109.0001 660.9246)" font-family="'MyriadPro-Regular'" font-size="16px">Cuspid</text>
                <text id="txtTooth26" transform="matrix(1 0 0 1 145.6668 678.2579)" font-family="'MyriadPro-Regular'" font-size="16px">Lateral incisor</text>
                <text id="txtTooth25" transform="matrix(1 0 0 1 191.6668 687.5912)" font-family="'MyriadPro-Regular'" font-size="16px">Central incisors</text>
                <text id="txtTooth24" transform="matrix(1 0 0 1 233.0001 687.5915)" font-family="'MyriadPro-Regular'" font-size="16px"></text>
                <text id="txtTooth23" transform="matrix(1 0 0 1 283.0001 673.5915)" font-family="'MyriadPro-Regular'" font-size="16px">Lateral incisor</text>
                <text id="txtTooth22" transform="matrix(1 0 0 1 329.6668 644.9248)" font-family="'MyriadPro-Regular'" font-size="16px">Cuspid</text>
                <text id="txtTooth21" transform="matrix(1 0 0 1 359.6668 604.9248)" font-family="'MyriadPro-Regular'" font-size="16px">1st Biscuspid</text>
                <text id="txtTooth20" transform="matrix(1 0 0 1 390.3334 558.2581)" font-family="'MyriadPro-Regular'" font-size="16px">2nd Bicuspid</text>
                <text id="txtTooth19" transform="matrix(1 0 0 1 412.6435 494.2493)" font-family="'MyriadPro-Regular'" font-size="16px">1st Molar</text>
                <text id="txtTooth18" transform="matrix(1 0 0 1 416.1565 449.7382)" font-family="'MyriadPro-Regular'" font-size="16px">2nd Molar</text>
                <text id="txtTooth17" transform="matrix(1 0 0 1 409.9765 386.378)" font-family="'MyriadPro-Regular'" font-size="16px">3rd Molar</text>
                <text id="txtTooth16" transform="matrix(1 0 0 1 410.5356 325.845)" font-family="'MyriadPro-Regular'" font-size="16px">3rd Molar</text>
                <text id="txtTooth15" transform="matrix(1 0 0 1 414.0005 251.8453)" font-family="'MyriadPro-Regular'" font-size="16px">2nd Molar</text>
                <text id="txtTooth14" transform="matrix(1 0 0 1 408.7707 211.7113)" font-family="'MyriadPro-Regular'" font-size="16px">1st Molar</text>
                <text id="txtTooth13" transform="matrix(1 0 0 1 386.7073 165.7383)" font-family="'MyriadPro-Regular'" font-size="16px">2nd Bicuspid</text>
                <text id="txtTooth12" transform="matrix(1 0 0 1 360.5876 123.5825)" font-family="'MyriadPro-Regular'" font-size="16px">1st Bicuspid</text>
                <text id="txtTooth11" transform="matrix(1 0 0 1 344.0069 89.5916)" font-family="'MyriadPro-Regular'" font-size="16px">Cuspid</text>
                <text id="txtTooth10" transform="matrix(1 0 0 1 301.0546 54.1648)" font-family="'MyriadPro-Regular'" font-size="16px">Lateral incisor</text>
                <text id="txtTooth9" transform="matrix(1 0 0 1 229.2251 29.2916)" font-family="'MyriadPro-Regular'" font-size="16px"></text>
                <text id="txtTooth8" transform="matrix(1 0 0 1 172.7413 30.3285)" font-family="'MyriadPro-Regular'" font-size="16px">Central incisors</text>
                <text id="txtTooth7" transform="matrix(1 0 0 1 114.3296 51.5455)" font-family="'MyriadPro-Regular'" font-size="16px">Lateral incisor</text>
                <text id="txtTooth6" transform="matrix(1 0 0 1 72.0002 91.2056)" font-family="'MyriadPro-Regular'" font-size="16px">Cuspid</text>
                <text id="txtTooth5" transform="matrix(1 0 0 1 48.5357 127.8719)" font-family="'MyriadPro-Regular'" font-size="16px">1st Bicuspid</text>
                <text id="txtTooth4" transform="matrix(1 0 0 1 27.2052 167.0134)" font-family="'MyriadPro-Regular'" font-size="16px">2nd Bicuspid</text>
                <text id="txtTooth3" transform="matrix(1 0 0 1 8.7983 212.3336)" font-family="'MyriadPro-Regular'" font-size="16px">1st Molar</text>
                <text id="txtTooth2" transform="matrix(1 0 0 1 3.25 260.1059)" font-family="'MyriadPro-Regular'" font-size="16px">2nd Molar</text>
                <text id="txtTooth1" transform="matrix(1 0 0 1 5.0001 338.4393)" font-family="'MyriadPro-Regular'" font-size="16px">3rd Molar</text>
            </g>
            <g id="Spots">
                <polygon id="Tooth32" fill="#FFFFFF" data-key="32" points="66.7,369.7 59,370.3 51,373.7 43.7,384.3 42.3,392 38.7,406 41,415.3 44.3,420.3 
                    ...
                    80.7,375 73.7,371.3 	" onclick="myfunction32()"/>
                <polygon id="Tooth31" fill="#FFFFFF" data-key="31" points="76,425.7 80.3,427.7 83.3,433 85.3,447.7 84.3,458.7 79.7,472.3 73,475 50.3,479.7 
                    46.7,476.7 37.7,446.3 39.7,438.3 43.3,432 49,426.7 56,424.7 65,424.7 	" onclick="myfunction31()"/>
                <polygon id="Tooth30" fill="#FFFFFF" data-key="30" points="78.7,476 85,481 90.3,488.3 96.3,499.3 97.7,511.3 93,522 86,526.3 67,533 
                    60.3,529.7 56.3,523.7 51.7,511 47.7,494.7 47.7,488.3 50.3,483.3 55,479.7 67,476.7 	" onclick="myfunction30()"/>
                <polygon id="Tooth29" fill="#FFFFFF" data-key="29" points="93.3,525 99.3,527.3 108.3,536 114,546.7 115.7,559.3 114.3,567.3 106.3,573 
                    98.3,578.3 88,579 82,575 75,565 69.3,552.3 67.3,542 69.7,536 74.3,531.7 84.3,528.3 	"onclick="myfunction29()"/>
                <path id="Tooth28" fill="#FFFFFF" data-key="28" d="M117.3,569.7l7.7,1.3l6.3,3.7l6.3,7.7l4,8.3L144,602l-1.3,6.7l-6.7,6.7l-7.7,3.3l-7.3-1l-7-3
                    l-7.3-7l-5-9l-2-10c0,0-0.7-7,0.3-7.3c1-0.3,5.3-6.7,5.3-6.7l9-5H117.3z" onclick="myfunction28()"/>
                <polygon id="Tooth27" fill="#FFFFFF" data-key="27" points="155.7,611 160.3,615.3 165,624.7 161.7,634.3 156,641.3 149,644 140.7,644.3 
                    133.3,641.3 128.7,634.7 128.7,629 132.7,621.3 137.7,615 143.7,611 149.7,610 	" onclick="myfunction27()"/>
                <polygon id="Tooth26" fill="#FFFFFF" data-key="26" points="178.3,627 186,629 187.7,633.7 188.7,644 189,657 189.3,662.7 186.3,663.7 176.7,663 
                    168,656.3 159.3,649.7 156.7,644 162,639.3 	" onclick="myfunction26()"/>
                <polygon id="Tooth25" fill="#FFFFFF" data-key="25" points="214,637 218,642.7 223,654.3 225.7,664 225.3,666.3 219,668.3 206.7,668 196,665.7 
                    190.3,662.7 193,657.3 199.7,647.3 207,638 210.7,635.5 	" onclick="myfunction25()"/>
                <path id="Tooth24" fill="#FFFFFF" data-key="24" d="M235.3,637c0,0,3-2,4-2.3c1-0.3,4.3,0,4.3,0l5,4.3l5.3,7.3l3.3,6.7l2,7.3l-2,3l-7.7,2.7
                    l-10,0.3h-10l-2-6.7l2.7-7.3L235.3,637z" onclick="myfunction24()"/>
                <polygon id="Tooth23" fill="#FFFFFF" data-key="23" points="269.3,624 273.3,624.7 275.3,627.3 279,628.7 281.7,631.3 285.3,634.7 289.3,638.3 
                    292,643.3 291.3,650 287,655 280.7,658.7 272,660 265,660.7 261.3,657.3 261.7,650 263.7,637 264.3,627 	" onclick="myfunction23()"/>
                <polygon id="Tooth22" fill="#FFFFFF" data-key="22" points="286,629.3 286.7,633.3 291.3,638.7 295.3,642.3 302,644 311.7,643.3 318.3,637.7 
                    321,630 321.3,620.3 317,614.3 308,608 298.3,607 291,609.3 287,612.3 286.7,617.7 287.3,624.7 	" onclick="myfunction22()"/>
                <polygon id="Tooth21" fill="#FFFFFF" data-key="21" points="331,565.7 335,565.7 341.3,568 349.3,574.3 352.3,578.3 352.7,583.7 350.7,593.7 
                    342.7,604 337.7,609 328,612.7 320,613.3 315,611 308.3,604.7 306.7,598 307.3,591.3 309,584.7 312.7,578.3 318.3,571.7 	" onclick="myfunction21()"/>
                <polygon id="Tooth20" fill="#FFFFFF" data-key="20" points="334,561 338.7,566 346,570 354.7,573 360.7,571.7 368,568.3 383,545 385.3,532.7 
                    381.3,524.3 374,520.7 363.7,516.3 356.3,515.3 351.3,518.3 346.3,524 340.3,534.3 336,546.7 	" onclick="myfunction20()"/>
                <path id="Tooth19" fill="#FFFFFF" data-key="19" d="M398,470l4.7,5.7l3,7.7l-0.3,11.7l-6,13.3l-6.3,10.3l-8.3,4.3l-7.3-1l-16.3-7c0,0-2.7-6-3-7.3
                    c-0.3-1.3-0.3-11-0.3-11l3.7-14.3l3.7-7l5.3-6.7l8-2l9.7-0.7L398,470z" onclick="myfunction19()"/>
                <polygon id="Tooth18" fill="#FFFFFF" data-key="18" points="410,435 408.7,447.3 404.3,459 399.3,467.7 393.7,468 388,466 376.3,466.3 
                    ...
                    407.7,427.3 	" onclick="myfunction18()"/>
                <polygon id="Tooth17" fill="#FFFFFF" data-key="17" points="371.7,417 378.3,417.3 386.7,415.7 391.7,415.3 397.3,417.7 402.7,416.3 407.7,409.7 
                    406.7,395 401,377.7 397.3,373 390.7,367.3 380,365 373,366.7 367.3,369 364,374.3 360,389 363.3,401.3 367.7,412.3 	" onclick="myfunction17()"/>
                <polygon id="Tooth16" fill="#FFFFFF" data-key="16" points="404.3,293.7 408.7,299.3 408.7,308 405.3,318.7 401,329.7 392.3,339.7 382.7,341 
                    369,339.7 359,335 354.7,327.7 354.3,316 358.3,304 363.7,294 368.7,294.7 378.7,296 389,296 	" onclick="myfunction16()"/>
                <polygon id="Tooth15" fill="#FFFFFF" data-key="15" points="362.3,247.3 357.3,251 357,259.3 358.7,268 359.7,279.7 361.3,286.7 365,291.7 
                    371,294.3 392,295 404.3,293.7 410,280.7 412,263.3 407.3,246.7 401,240.3 396,239.7 389.3,243 	" onclick="myfunction15()"/>
                <polygon id="Tooth14" fill="#FFFFFF" data-key="14" points="359.7,243.7 350.7,224 345.7,211.7 348.7,205 358.3,202.7 375.7,197 388.7,193 
                    393,196 399.3,207 401.3,222.7 400,234.3 394.7,240.7 381.7,244.7 371,246 	" onclick="myfunction14()"/>
                <polygon id="Tooth13" fill="#FFFFFF" data-key="13" points="386,188.7 383.3,192.7 377.7,196 356.3,203.3 345.7,202.3 341.7,199.7 338.7,196.3 
                    ...
                    383.3,178.3 	" onclick="myfunction13()"/>
                <polygon id="Tooth12" fill="#FFFFFF" data-key="12" points="358.7,134.3 360.3,145.7 357.3,152.7 352,157.3 346.3,161 336,164 329.7,163.3 
                    ...
                    348.7,122.7 354.3,127.7 	" onclick="myfunction12()"/>
                <polygon id="Tooth11" fill="#FFFFFF" data-key="11" points="336,93.3 337.7,100 336,104.7 332.7,113.7 324.3,121.3 315.3,125.7 306.3,126 
                    297.3,120.3 294,112 295.7,102.7 299,95 303.3,90 309.3,88 316.3,87.3 322.7,87.3 328,88.3 	" onclick="myfunction11()"/>
                <polygon id="Tooth10" fill="#FFFFFF" data-key="10" points="310.3,83.3 298,90.7 286,95 276.3,98.3 270.3,93.3 269,82.7 269,69.3 270,58.7 
                    274.7,54.7 282,53 287.7,54.7 297.3,60.3 304,64.3 308.7,68.7 312.3,74 313,81 	" onclick="myfunction10()"/>
                <polygon id="Tooth9" fill="#FFFFFF" data-key="9" points="273.3,52 266.7,61.7 258.3,72.3 253.3,79.7 247.3,85 239,87.7 232.3,82 224.7,67 
                    222,58.3 219,50 220,44.3 224.3,40.3 230,38.7 237.3,38.7 253,39.3 258.7,41.3 264.3,43.7 268.3,45.7 	" onclick="myfunction9()"/>
                <polygon id="Tooth8" fill="#FFFFFF" data-key="8" points="176.7,46.3 195,41 203.3,39.7 209.3,40.7 215.3,42.7 217,47 217.7,54.3 215,64.7 
                    212.3,75.7 208,83 201.7,85.7 195.7,86.7 189.7,83.3 183.7,74.7 175,62 171.7,54 172.7,49.7 	" onclick="myfunction8()"/>
                <path id="Tooth7" fill="#FFFFFF" data-key="7" d="M167,55l6.7,6.3L174,68l0.3,8l1,10l-2,8.3l-4.7,4.3l-6.7,1.7l-8-4.3l-7.3-4.7l-9.3-4.7
                    l-6.3-5.3l-1-4.3l1.3-5c0,0,3.3-6,4.3-6s5.3-6,6.3-6s10.3-4.7,10.3-4.7L167,55z" onclick="myfunction7()"/>
                <polygon id="Tooth6" fill="#FFFFFF" data-key="6" points="126.3,82 134.3,86.3 139.7,92.3 144.7,104.7 145.7,115.3 143.7,120.7 138,124.3 
                    131.3,125 121,125 114.7,119.3 110.3,112.3 108.3,104.7 108.7,94.7 110.7,88.7 116,84 	" onclick="myfunction6()"/>
                <polygon id="Tooth5" fill="#FFFFFF" data-key="5" points="109,116.7 116,122.3 122.7,125.3 127.7,131.3 128.3,141 122.7,153.7 114,161.7 
                    105.7,162.3 96.7,161 85.7,156 82,150 81,139.3 86.3,128 93,121.3 100.7,117.3 	" onclick="myfunction5()"/>
                <polygon id="Tooth4" fill="#FFFFFF" data-key="4" points="82,155.3 102.3,163.3 108.7,172 109.3,182 104.7,192 100,199 94,203.7 85.3,201.7 
                    73.7,201 64.3,196.7 60.3,190.7 59,183.3 61.7,175.3 66.3,167.7 71.3,161.3 	" onclick="myfunction4()"/>
                <path id="Tooth3" fill="#FFFFFF" data-key="3" d="M92.7,207.3l2,5.3l-1.7,8l-1.7,9l-4,8l-5,7.7l-11,4.7l-13.7,0.7l-10-7l-1.7-5L45,220l3-10.7
                    l5-7.3l4-3.3l4.7-2.7l5.3,3.7l6.7,1.3c0,0,7.3,1.3,9.3,1.3s6.3,0.7,6.3,0.7L92.7,207.3z" onclick="myfunction3()"/>
                <polygon id="Tooth2" fill="#FFFFFF" data-key="2" points="79.7,288.3 71.7,291 55,293 40.3,291.3 36,287 33,273.7 36.3,260 42,248.7 44.7,244.7 
                    50.3,246.7 56,249 65.3,250.7 74,249.7 80.3,249.7 82.3,254 85.3,259.3 87,267.7 87.7,274.7 85.3,282.7 	" onclick="myfunction2()"/>
                <polygon id="Tooth1" fill="#FFFFFF" data-key="1" points="33,314.3 38,325.7 45.7,335.7 55.7,341.7 64.7,343 73.3,340 77.7,335.7 81.3,326.3 
                    82,314.3 81.3,302 80.7,292.7 73.7,292 51.3,293.7 38.7,293.7 34,298 31.7,302.3 32,311 	" onclick="myfunction1()"/>
            </g>
            <g id="adult-outlines">
                <g id="XMLID_210_">
            ...
            <div >
                <input type="text" class="tooth_sendd" id="smile" hidden>
                <!-- <small id="smile" style="color:e74c3c"></small> -->
                <button type="button" class="edit_btn btn btn-outline-primary" style=" margin:20px; position: absolute; right: 0; width:250px">Push</button>
            </div>
            ...
            <!-- <div style="margin-bottom:70px">
                <input type="button" class="btn btn-primary" style="margin:20px; position: absolute; right: 0; width:250px" name="save" id="save" value="Save">
            </div> -->
        </div>
        </section>
        ...
        <div class="page-content">
            ...
            <div class="table-responsive" style="padding:20px">
                <table class="table table-bordered">
                    ...
                    mysqli_select_db($con, 'doc_project');
                    $opd=$_SESSION["p_id"];
                    $commands = "select * from p_dental_treatment where opd ='$opd' and tooth_number>50";
                    $results = mysqli_query($con, $commands);
                    while($rowss = mysqli_fetch_array($results)):
                    ?>
            ...
            <center>
            <div class="tooth-chart1">
                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                    viewBox="0 0 450 700" enable-background="new 0 0 450 700" xml:space="preserve">
                <g class="toothLabels">
                    <text id="lblT" transform="matrix(1 0 0 1 109.31 423.6409)" font-family="'Avenir-Heavy'" font-size="24px">85</text>
                    <text id="lblS" transform="matrix(1 0 0 1 126.7426 490.0023)" font-family="'Avenir-Heavy'" font-size="24px">84</text>
                    <text id="lblR" transform="matrix(1 0 0 1 146.5064 533.043)" font-family="'Avenir-Heavy'" font-size="24px">83</text>
                    <text id="lblQ" transform="matrix(1 0 0 1 168.0594 560.1663)" font-family="'Avenir-Heavy'" font-size="21px">82</text>
                    <text id="lblP" transform="matrix(1 0 0 1 201.0274 564.6503)" font-family="'Avenir-Heavy'" font-size="21px">81</text>
                    <text id="lblO" transform="matrix(1 0 0 1 229.0002 564.6497)" font-family="'Avenir-Heavy'" font-size="21px">71</text>
                    <text id="lblN" transform="matrix(1 0 0 1 261.966 560.167)" font-family="'Avenir-Heavy'" font-size="21px">72</text>
                    <text id="lblM" transform="matrix(1 0 0 1 274.6497 533.0432)" font-family="'Avenir-Heavy'" font-size="24px">73</text>
                    <text id="lblL" transform="matrix(1 0 0 1 301.4584 490.002)" font-family="'Avenir-Heavy'" font-size="24px">74</text>
                    <text id="lblK" transform="matrix(1 0 0 1 318.6671 423.6405)" font-family="'Avenir-Heavy'" font-size="24px">75</text>
                    <text id="lblJ" transform="matrix(1 0 0 1 326.1867 278.9355)" font-family="'Avenir-Heavy'" font-size="24px">65</text>
                    <text id="lblI" transform="matrix(1 0 0 1 308.6669 224.1667)" font-family="'Avenir-Heavy'" font-size="24px">64</text>
                    <text id="lblH" transform="matrix(1 0 0 1 280.8936 185.2723)" font-family="'Avenir-Heavy'" font-size="24px">63</text>
                    <text id="lblG" transform="matrix(1 0 0 1 256.5099 157.1388)" font-family="'Avenir-Heavy'" font-size="24px">62</text>
                    <text id="lblF" transform="matrix(1 0 0 1 230.6667 151.667)" font-family="'Avenir-Heavy'" font-size="24px">61</text>
                    <text id="lblE" transform="matrix(1 0 0 1 196.0272 151.6668)" font-family="'Avenir-Heavy'" font-size="24px">51</text>
                    <text id="lblD" transform="matrix(1 0 0 1 166.0594 157.1387)" font-family="'Avenir-Heavy'" font-size="24px">52</text>
                    <text id="lblC" transform="matrix(1 0 0 1 147.1964 185.2724)" font-family="'Avenir-Heavy'" font-size="24px">53</text>
                    <text id="lblB" transform="matrix(1 0 0 1 121.5838 224.1666)" font-family="'Avenir-Heavy'" font-size="24px">54</text>
                    <text id="lblA" transform="matrix(1 0 0 1 109.31 278.9357)" font-family="'Avenir-Heavy'" font-size="24px">55</text>
                </g>
                <g class="dtfmLabels">
                    <text id="txtToothT" transform="matrix(1 0 0 1 1.0001 447.0915)" font-family="'MyriadPro-Regular'" font-size="16px">2nd Molar</text>
                    <text id="txtToothS" transform="matrix(1 0 0 1 23.3102 506.416)" font-family="'MyriadPro-Regular'" font-size="16px">1st Molar</text>
                    <text id="txtToothR" transform="matrix(1 0 0 1 57.4898 569.9049)" font-family="'MyriadPro-Regular'" font-size="16px">Canine</text>
                    <text id="txtToothQ" transform="matrix(1 0 0 1 109.3098 618.5447)" font-family="'MyriadPro-Regular'" font-size="16px">Lateral incisors</text>
                    <text id="txtToothP" transform="matrix(1 0 0 1 173.8689 642.0117)" font-family="'MyriadPro-Regular'" font-size="16px">Central incisors</text>
                    <text id="txtToothO" transform="matrix(1 0 0 1 236.6671 642.012)" font-family="'MyriadPro-Regular'" font-size="16px"></text>
                    <text id="txtToothN" transform="matrix(1 0 0 1 300.104 618.5447)" font-family="'MyriadPro-Regular'" font-size="16px">Lateral incisors</text>
                    <text id="txtToothM" transform="matrix(1 0 0 1 358.7073 569.905)" font-family="'MyriadPro-Regular'" font-size="16px">Canine</text>
                    <text id="txtToothL" transform="matrix(1 0 0 1 393.2542 506.4159)" font-family="'MyriadPro-Regular'" font-size="16px">1st Molar</text>
                    <text id="txtToothK" transform="matrix(1 0 0 1 405.3402 447.0916)" font-family="'MyriadPro-Regular'" font-size="16px">2nd Molar</text>
                    <text id="txtToothJ" transform="matrix(1 0 0 1 411.0546 240.9981)" font-family="'MyriadPro-Regular'" font-size="16px">2nd Molar</text>
                    <text id="txtToothI" transform="matrix(1 0 0 1 390.5584 186.7916)" font-family="'MyriadPro-Regular'" font-size="16px">1st Molar</text>
                    <text id="txtToothH" transform="matrix(1 0 0 1 362.0746 133.1618)" font-family="'MyriadPro-Regular'" font-size="16px">Canine</text>
                    <text id="txtToothG" transform="matrix(1 0 0 1 314.9963 97.0455)" font-family="'MyriadPro-Regular'" font-size="16px">Lateral incisors</text>
                    <text id="txtToothF" transform="matrix(1 0 0 1 236.6669 69.3723)" font-family="'MyriadPro-Regular'" font-size="16px"></text>
                    <text id="txtToothE" transform="matrix(1 0 0 1 173.869 69.3719)" font-family="'MyriadPro-Regular'" font-size="16px">Central incisors</text>
                    <text id="txtToothD" transform="matrix(1 0 0 1 111.8719 90.5134)" font-family="'MyriadPro-Regular'" font-size="16px">Lateral incisors</text>
                    <text id="txtToothC" transform="matrix(1 0 0 1 59.4649 141.1669)" font-family="'MyriadPro-Regular'" font-size="16px">Canine</text>
                    <text id="txtToothB" transform="matrix(1 0 0 1 25.25 184.2726)" font-family="'MyriadPro-Regular'" font-size="16px">1st Molar</text>
                    <text id="txtToothA" transform="matrix(1 0 0 1 7.6667 247.2726)" font-family="'MyriadPro-Regular'" font-size="16px">2nd Molar</text>
                </g>
                <g class="spots">
                    <polygon id="ToothT" fill="#FFFFFF" data-key="T" points="65.7,373.5 74,375.2 82,380.8 86.3,384.8 90.3,390.2 92.7,395.8 93,404.8 93,416.8 
                        ...
                        36.3,425.2 33.3,407.8 34.3,399.5 36,392.8 39.7,383.5 47,377.2 57,373.2 	" onclick="myfunction85()"/>
                    <polygon id="ToothS" fill="#FFFFFF" data-key="S" points="93.7,456.2 82.7,455.8 70.7,460.8 66.3,467.2 63.7,474.2 62,487.2 63.3,500.2 
                        ...
                        114.3,484.5 108.7,470.8 103,462.5 	" onclick="myfunction84()"/>
                    <polygon id="ToothR" fill="#FFFFFF" data-key="R" points="129.3,532.2 137,535.2 142.7,541.2 146,548.8 147.7,557.8 144.7,565.2 136.7,570.5 
                        123,573.8 113,574.2 105,572.8 101.3,564.8 103,551.2 107.3,541.2 111.3,535.5 124,531.5 	" onclick="myfunction83()"/>
                    <polygon id="ToothQ" fill="#FFFFFF" data-key="Q" points="164.3,564.5 168.3,568.8 173,592.2 172,598.2 169.3,601.8 162,601.8 152,599.8 
                        142.3,595.5 131,586.8 130.7,584.5 135,575.8 140.3,570.2 149.7,564.5 159,562.8 	" onclick="myfunction82()"/>
                    <polygon id="ToothP" fill="#FFFFFF" data-key="P" points="208,576.5 218,607.2 214,611.5 206.7,613.2 191,612.8 179,606.8 172.3,601.5 
                        174,597.8 190.3,578.2 199.7,571.8 205.7,573.8 	" onclick="myfunction81()"/>
                    <polygon id="ToothO" fill="#FFFFFF" data-key="O" points="244.3,574.2 235.7,575.2 230.7,581.8 225.7,593.5 221.7,604.5 220.3,609.8 224,613.5 
                        234.3,615.5 248.7,613.8 258.7,610.8 264,606.2 265.3,598.8 	" onclick="myfunction71()"/>
                    <polygon id="ToothN" fill="#FFFFFF" data-key="N" points="306.3,575.8 298.7,569.2 289.7,566.2 280.7,564.2 275.3,566.8 272,572.2 268.7,583.8 
                        267.3,593.2 266.3,599.2 266.7,603.8 270.7,607.8 276.3,608.8 286.7,605.2 300,597.5 307.7,590.5 309,583.5 	" onclick="myfunction72()"/>
                    <polygon id="ToothM" fill="#FFFFFF" data-key="M" points="335,532.2 341.7,546.5 343.3,562.8 339.7,570.5 331.7,573.5 309,572.5 302,569.2 
                        298,564.5 299.7,548.2 303,539.5 307.3,531.8 315.3,525.2 321.3,525.2 325,525.5 	" onclick="myfunction73()"/>
                    <polygon id="ToothL" fill="#FFFFFF" data-key="L" points="354,450.2 365.7,453.8 377,459.5 384.3,469.2 385,481.5 382.7,491.8 369.7,517.8 
                        357.3,527.8 340.7,532.2 331.7,528.5 324.3,523.5 321,515.2 320.7,504.2 325.3,489.5 330.3,470.2 335,460.5 343.7,453.2 	" onclick="myfunction74()"/>
                    <polygon id="ToothK" fill="#FFFFFF" data-key="K" points="391.7,370.2 379,367.8 366.7,370.2 356.3,378.8 350.3,388.2 347.7,396.2 348,411.5 
                        ...
                        406.7,413.5 409.7,400.5 408.7,390.5 404.3,380.2 	" onclick="myfunction75()"/>
                    <polygon id="ToothJ" fill="#FFFFFF" data-key="J" points="384.3,231.2 391.3,232.5 402.3,241.5 409,253.8 414.3,267.2 416,281.8 413.7,300.2 
                        ...
                        351.7,248.2 357.7,239.5 367.7,237.5 	" onclick="myfunction65()"/>
                    <polygon id="ToothI" fill="#FFFFFF" data-key="I" points="359.3,167.2 367.3,169.8 375.3,182.5 384,199.8 389.7,211.8 389.3,220.5 386,227.5 
                        377.3,233.5 363.3,238.5 355.3,237.5 348.3,233.2 343.3,224.8 337,211.5 330.7,195.8 328,186.8 332.7,175.2 342.7,168.5 	" onclick="myfunction64()"/>
                    <polygon id="ToothH" fill="#FFFFFF" data-key="H" points="305.7,136.5 303,143.8 301,150.5 304,161.5 313,170.2 323,172.8 331.7,172.5 
                        339.3,168.8 346,162.5 350.3,152.2 351.3,141.2 347.3,134.5 343,132.2 334,131.5 322.3,130.2 316,129.8 	" onclick="myfunction63()"/>
                    <polygon id="ToothG" fill="#FFFFFF" data-key="G" points="277.3,98.8 276.7,107.2 276,119.2 276,129.5 279.7,138.2 285.7,141.2 293.3,141.5 
                        301.7,135.8 316.7,126.8 320,122.5 320,116.2 316.3,109.8 301.7,101.8 294.7,98.8 282,97.5 	" onclick="myfunction62()"/>
                    <polygon id="ToothF" fill="#FFFFFF" data-key="F" points="222,87.5 222.7,93.8 226.7,98.2 231,107.8 236.7,121.5 242,125.8 248,126.8 257,120.2 
                        275.3,101.5 276,95.2 273.7,92.2 266,85.8 248.7,80.5 236.3,80.2 229,81.8 	" onclick="myfunction61()"/>
                    <polygon id="ToothE" fill="#FFFFFF" data-key="E" points="168.3,94.5 172,103.5 175.3,107.5 184,120.5 190.3,127.5 198.7,128.5 203.3,124.8 
                        209.7,115.2 219.7,92.5 218.7,85.8 209,83.8 191.3,82.5 182,84.2 173.7,88.2 	" onclick="myfunction51()"/>
                    <polygon id="ToothD" fill="#FFFFFF" data-key="D" points="123.7,124.2 131.3,131.2 143.3,137.5 151.3,141.8 159,142.5 165.7,137.5 169.3,125.8 
                        169,108.8 169.7,100.2 165,95.5 158.3,95.2 145.7,97.8 138.7,102.5 130,108.2 124.3,114.2 	" onclick="myfunction52()"/>
                    <polygon id="ToothC" fill="#FFFFFF" data-key="C" points="106.7,132.2 118,132.2 130.3,132.5 139.7,138.2 144.7,147.8 144.7,160.8 134.3,173.8 
                        121.7,180.2 115,180.2 107.7,174.5 100,169.8 98.7,156.8 97.3,147.8 98.3,138.8 104.7,133.2 	" onclick="myfunction53()"/>
                    <polygon id="ToothB" fill="#FFFFFF" data-key="B" points="90.2,242.2 97.3,236.1 106.3,224.2 114.9,200.1 117.3,189.4 113,179.1 95.7,169.8 
                        86.2,169.8 71.9,179.1 63.5,191.3 58.6,202.5 54,215.2 55.8,227.2 65.8,238.9 79.1,242.2 	" onclick="myfunction54()"/>
                    <polygon id="ToothA" fill="#FFFFFF" data-key="A" points="55.2,236.1 60,237.2 69.8,240.2 86.9,243.3 92,247 95.7,255.8 95.7,271.2 94.7,286.5 
                        90.2,305.2 82.8,312.8 72,318.5 56.7,319.3 48.8,317.5 40.8,311.5 33,300.3 31.3,284.7 34.2,273.8 39.3,256.3 42.3,248 	" onclick="myfunction55()"/>
                </g>
                <g id="child-outlines">
                    <g id="XMLID_9_">
            ...
            <div >
                <input type="text" class="tooth_sendd" id="smile1" hidden>
                <!-- <small id="smile" style="color:e74c3c"></small> -->
                <button type="button" class="edit_btn btn btn-outline-primary" style=" margin:20px; position: absolute; right: 0; width:250px">Push</button>
            </div>
    ...
    function myfunction1() {
        // var n = teeths.includes(18);

        if(tooth_selected==""){
            document.getElementById("Tooth1").style.fill = '#4481eb';
            // teeths.push(18);
            tooth_selected="18";
            document.getElementById("smile").value = "18";

        }
        else{
            if(tooth_selected=="18"){
                document.getElementById("Tooth1").style.fill = '#ffffff';
                // teeths = arrayRemove(teeths, 18)
                tooth_selected="";
    ...
    function myfunction2() {
        // var n = teeths.includes("17");
        if(tooth_selected==""){
            document.getElementById("Tooth2").style.fill = '#4481eb';
            // teeths.push("17");
            tooth_selected="17";
            document.getElementById("smile").value = "17";
        }
        else{
            if(tooth_selected=="17"){
                document.getElementById("Tooth2").style.fill = '#ffffff';
                // teeths = arrayRemove(teeths, "17")
                tooth_selected="";
                document.getElementById("smile").value = "";
            }
        }
    ...
    function myfunction3() {
        // var n = teeths.includes("16");
        if(tooth_selected==""){
            document.getElementById("Tooth3").style.fill = '#4481eb';
            // teeths.push("16");
            tooth_selected="16";
            document.getElementById("smile").value = "16";
        }
        else{
            if(tooth_selected=="16"){
                document.getElementById("Tooth3").style.fill = '#ffffff';
                // teeths = arrayRemove(teeths, "16")
                tooth_selected="";
                document.getElementById("smile").value = "";
            }
        }
    ...
    function myfunction4() {
        // var n = teeths.includes("15");
        if(tooth_selected==""){
            document.getElementById("Tooth4").style.fill = '#4481eb';
            // teeths.push("15");
            tooth_selected="15";
            document.getElementById("smile").value = "15";
        }
        else{
            if(tooth_selected=="15"){
                document.getElementById("Tooth4").style.fill = '#ffffff';
                // teeths = arrayRemove(teeths, "15")
                tooth_selected="";
                document.getElementById("smile").value = "";
            }
        }
    ...
    function myfunction5() {
        // var n = teeths.includes("14");
        if(tooth_selected==""){
            document.getElementById("Tooth5").style.fill = '#4481eb';
            // teeths.push("14");
            tooth_selected="14";
            document.getElementById("smile").value = "14";
        }
        else{
            if(tooth_selected=="14"){
                document.getElementById("Tooth5").style.fill = '#ffffff';
                // teeths = arrayRemove(teeths, "14")
                tooth_selected="";
                document.getElementById("smile").value = "";
            }
        }
    ...
    function myfunction6() {
        // var n = teeths.includes("13");
        if(tooth_selected==""){
            document.getElementById("Tooth6").style.fill = '#4481eb';
            // teeths.push("13");
            tooth_selected="13";
            document.getElementById("smile").value = "13";
        }
        else{
            if(tooth_selected=="13"){
                document.getElementById("Tooth6").style.fill = '#ffffff';
                // teeths = arrayRemove(teeths, "13")
                tooth_selected="";
                document.getElementById("smile").value = "";
            }
        }
    ...
    function myfunction7() {
        // var n = teeths.includes("12");
        if(tooth_selected==""){
            document.getElementById("Tooth7").style.fill = '#4481eb';
            // teeths.push("12");
            tooth_selected="12";
            document.getElementById("smile").value = "12";
        }
        else{
            if(tooth_selected=="12"){
                document.getElementById("Tooth7").style.fill = '#ffffff';
                // teeths = arrayRemove(teeths, "12")
                tooth_selected="";
                document.getElementById("smile").value = "";
            }
        }
    ...
    function myfunction8() {
        // var n = teeths.includes("11");
        if(tooth_selected==""){
            document.getElementById("Tooth8").style.fill = '#4481eb';
            // teeths.push("11");
            tooth_selected="11";
            document.getElementById("smile").value = "11";
        }
        else{
            if(tooth_selected=="11"){
                document.getElementById("Tooth8").style.fill = '#ffffff';
                // teeths = arrayRemove(teeths, "11")
                tooth_selected="";
                document.getElementById("smile").value = "";
            }
        }
    ...
    function myfunction9() {
        // var n = teeths.includes("21");
        if(tooth_selected==""){
            document.getElementById("Tooth9").style.fill = '#4481eb';
            // teeths.push("21");
            tooth_selected="21";
            document.getElementById("smile").value = "21";
        }
        else{
            if(tooth_selected=="21"){
                document.getElementById("Tooth9").style.fill = '#ffffff';
                // teeths = arrayRemove(teeths, "21")
                tooth_selected="";
                document.getElementById("smile").value = "";
            }
        }
    ...
    function myfunction10() {
        // var n = teeths.includes("22");
        if(tooth_selected==""){
            document.getElementById("Tooth10").style.fill = '#4481eb';
            // teeths.push("22");
            tooth_selected="22";
            document.getElementById("smile").value = "22";
        }
        else{
            if(tooth_selected=="22"){
                document.getElementById("Tooth10").style.fill = '#ffffff';
                // teeths = arrayRemove(teeths, "22")
                tooth_selected="";
                document.getElementById("smile").value = "";
            }
        }
    ...
    function myfunction11() {
        // var n = teeths.includes("23");
        if(tooth_selected==""){
            document.getElementById("Tooth11").style.fill = '#4481eb';
            // teeths.push("23");
            tooth_selected="23";
            document.getElementById("smile").value = "23";
        }
        else{
            if(tooth_selected=="23"){
                document.getElementById("Tooth11").style.fill = '#ffffff';
                // teeths = arrayRemove(teeths, "23")
                tooth_selected="";
                document.getElementById("smile").value = "";
            }
        }
    ...
    function myfunction12() {
        // var n = teeths.includes("24");
        if(tooth_selected==""){
            document.getElementById("Tooth12").style.fill = '#4481eb';
            // teeths.push("24");
            tooth_selected="24";
            document.getElementById("smile").value = "24";
        }
        else{
            if(tooth_selected=="24"){
                document.getElementById("Tooth12").style.fill = '#ffffff';
                // teeths = arrayRemove(teeths, "24")
                tooth_selected="";
                document.getElementById("smile").value = "";
            }
        }
    ...
    function myfunction13() {
        // var n = teeths.includes("25");
        if(tooth_selected==""){
            document.getElementById("Tooth13").style.fill = '#4481eb';
            // teeths.push("25");
            tooth_selected="25";
            document.getElementById("smile").value = "25";
        }
        else{
            if(tooth_selected=="25"){
                document.getElementById("Tooth13").style.fill = '#ffffff';
                // teeths = arrayRemove(teeths, "25")
                tooth_selected="";
                document.getElementById("smile").value = "";
            }
        }
    ...
    function myfunction14() {
        // var n = teeths.includes("26");
        if(tooth_selected==""){
            document.getElementById("Tooth14").style.fill = '#4481eb';
            // teeths.push("26");
            tooth_selected="26";
            document.getElementById("smile").value = "26";
        }
        else{
            if(tooth_selected=="26"){
                document.getElementById("Tooth14").style.fill = '#ffffff';
                // teeths = arrayRemove(teeths, "26")
                tooth_selected="";
                document.getElementById("smile").value = "";
            }
        }
    ...
    function myfunction15() {
        // var n = teeths.includes("27");
        if(tooth_selected==""){
            document.getElementById("Tooth15").style.fill = '#4481eb';
            // teeths.push("27");
            tooth_selected="27";
            document.getElementById("smile").value = "27";
        }
        else{
            if(tooth_selected=="27"){
                document.getElementById("Tooth15").style.fill = '#ffffff';
                // teeths = arrayRemove(teeths, "27")
                tooth_selected="";
                document.getElementById("smile").value = "";
            }
        }
    ...
    function myfunction16() {
        // var n = teeths.includes("28");
        if(tooth_selected==""){
            document.getElementById("Tooth16").style.fill = '#4481eb';
            // teeths.push("28");
            tooth_selected="28";
            document.getElementById("smile").value = "28";
        }
        else{
            if(tooth_selected=="28"){
                document.getElementById("Tooth16").style.fill = '#ffffff';
                // teeths = arrayRemove(teeths, "28")
                tooth_selected="";
                document.getElementById("smile").value = "";
            }
        }
    ...
    function myfunction17() {
        // var n = teeths.includes("38");
        if(tooth_selected==""){
            document.getElementById("Tooth17").style.fill = '#4481eb';
            // teeths.push("38");
            tooth_selected="38";
            document.getElementById("smile").value = "38";
        }
        else{
            if(tooth_selected=="38"){
                document.getElementById("Tooth17").style.fill = '#ffffff';
                // teeths = arrayRemove(teeths, "38")
                tooth_selected="";
                document.getElementById("smile").value = "";
            }
        }
    ...
    function myfunction18() {
        // var n = teeths.includes("37");
        if(tooth_selected==""){
            document.getElementById("Tooth18").style.fill = '#4481eb';
            // teeths.push("37");
            tooth_selected="37";
            document.getElementById("smile").value = "37";
        }
        else{
            if(tooth_selected=="37"){
                document.getElementById("Tooth18").style.fill = '#ffffff';
                // teeths = arrayRemove(teeths, "37")
                tooth_selected="";
                document.getElementById("smile").value = "";
            }
        }
    ...
    function myfunction19() {
        // var n = teeths.includes("36");
        if(tooth_selected==""){
            document.getElementById("Tooth19").style.fill = '#4481eb';
            // teeths.push("36");
            tooth_selected="36";
            document.getElementById("smile").value = "36";
        }
        else{
            if(tooth_selected=="36"){
                document.getElementById("Tooth19").style.fill = '#ffffff';
                // teeths = arrayRemove(teeths, "36")
                tooth_selected="";
                document.getElementById("smile").value = "";
            }
        }
    ...
    function myfunction20() {
        // var n = teeths.includes("35");
        if(tooth_selected==""){
            document.getElementById("Tooth20").style.fill = '#4481eb';
            // teeths.push("35");
            tooth_selected="35";
            document.getElementById("smile").value = "35";
        }
        else{
            if(tooth_selected=="35"){
                document.getElementById("Tooth20").style.fill = '#ffffff';
                // teeths = arrayRemove(teeths, "35")
                tooth_selected="";
                document.getElementById("smile").value = "";
            }
        }
    ...
    function myfunction21() {
        // var n = teeths.includes("34");
        if(tooth_selected==""){
            document.getElementById("Tooth21").style.fill = '#4481eb';
            // teeths.push("34");
            tooth_selected="34";
            document.getElementById("smile").value = "34";
        }
        else{
            if(tooth_selected=="34"){
                document.getElementById("Tooth21").style.fill = '#ffffff';
                // teeths = arrayRemove(teeths, "34")
                tooth_selected="";
                document.getElementById("smile").value = "";
            }
        }
    ...
    function myfunction22() {
        // var n = teeths.includes("33");
        if(tooth_selected==""){
            document.getElementById("Tooth22").style.fill = '#4481eb';
            // teeths.push("33");
            tooth_selected="33";
            document.getElementById("smile").value = "33";
        }
        else{
            if(tooth_selected=="33"){
                document.getElementById("Tooth22").style.fill = '#ffffff';
                // teeths = arrayRemove(teeths, "33")
                tooth_selected="";
                document.getElementById("smile").value = "";
            }
        }
    ...
    function myfunction23() {
        // var n = teeths.includes("32");
        if(tooth_selected==""){
            document.getElementById("Tooth23").style.fill = '#4481eb';
            // teeths.push("32");
            tooth_selected="32";
            document.getElementById("smile").value = "32";
        }
        else{
            if(tooth_selected=="32"){
                document.getElementById("Tooth23").style.fill = '#ffffff';
                // teeths = arrayRemove(teeths, "32")
                tooth_selected="";
                document.getElementById("smile").value = "";
            }
        }
    ...
    function myfunction24() {
        // var n = teeths.includes("31");
        if(tooth_selected==""){
            document.getElementById("Tooth24").style.fill = '#4481eb';
            // teeths.push("31");
            tooth_selected="31";
            document.getElementById("smile").value = "31";
        }
        else{
            if(tooth_selected=="31"){
                document.getElementById("Tooth24").style.fill = '#ffffff';
                // teeths = arrayRemove(teeths, "31")
                tooth_selected="";
                document.getElementById("smile").value = "";
            }
        }
    ...
    function myfunction25() {
        // var n = teeths.includes("41");
        if(tooth_selected==""){
            document.getElementById("Tooth25").style.fill = '#4481eb';
            // teeths.push("41");
            tooth_selected="41";
            document.getElementById("smile").value = "41";
        }
        else{
            if(tooth_selected=="41"){
                document.getElementById("Tooth25").style.fill = '#ffffff';
                // teeths = arrayRemove(teeths, "41")
                tooth_selected="";
                document.getElementById("smile").value = "";
            }
        }
    ...
    function myfunction26() {
        // var n = teeths.includes("42");
        if(tooth_selected==""){
            document.getElementById("Tooth26").style.fill = '#4481eb';
            // teeths.push("42");
            tooth_selected="42";
            document.getElementById("smile").value = "42";
        }
        else{
            if(tooth_selected=="42"){
                document.getElementById("Tooth26").style.fill = '#ffffff';
                // teeths = arrayRemove(teeths, "42")
                tooth_selected="";
                document.getElementById("smile").value = "";
            }
        }
    ...
    function myfunction27() {
        // var n = teeths.includes("43");
        if(tooth_selected==""){
            document.getElementById("Tooth27").style.fill = '#4481eb';
            // teeths.push("43");
            tooth_selected="43";
            document.getElementById("smile").value = "43";
        }
        else{
            if(tooth_selected=="43"){
                document.getElementById("Tooth27").style.fill = '#ffffff';
                // teeths = arrayRemove(teeths, "43")
                tooth_selected="";
                document.getElementById("smile").value = "";
            }
        }
    ...
    function myfunction28() {
        // var n = teeths.includes("44");
        if(tooth_selected==""){
            document.getElementById("Tooth28").style.fill = '#4481eb';
            // teeths.push("44");
            tooth_selected="44";
            document.getElementById("smile").value = "44";
        }
        else{
            if(tooth_selected=="44"){
                document.getElementById("Tooth28").style.fill = '#ffffff';
                // teeths = arrayRemove(teeths, "44")
                tooth_selected="";
                document.getElementById("smile").value = "";
            }
        }
    ...
    function myfunction29() {
        // var n = teeths.includes("45");
        if(tooth_selected==""){
            document.getElementById("Tooth29").style.fill = '#4481eb';
            // teeths.push("45");
            tooth_selected="45";
            document.getElementById("smile").value = "45";
        }
        else{
            if(tooth_selected=="45"){
                document.getElementById("Tooth29").style.fill = '#ffffff';
                // teeths = arrayRemove(teeths, "45")
                tooth_selected="";
                document.getElementById("smile").value = "";
            }
        }
    ...
    function myfunction30() {
        // var n = teeths.includes("46");
        if(tooth_selected==""){
            document.getElementById("Tooth30").style.fill = '#4481eb';
            // teeths.push("46");
            tooth_selected="46";
            document.getElementById("smile").value = "46";
        }
        else{
            if(tooth_selected=="46"){
                document.getElementById("Tooth30").style.fill = '#ffffff';
                // teeths = arrayRemove(teeths, "46")
                tooth_selected="";
                document.getElementById("smile").value = "";
            }
        }
    ...
    function myfunction31() {
        // var n = teeths.includes("47");
        if(tooth_selected==""){
            document.getElementById("Tooth31").style.fill = '#4481eb';
            // teeths.push("47");
            tooth_selected="47";
            document.getElementById("smile").value = "47";
        }
        else{
            if(tooth_selected=="47"){
                document.getElementById("Tooth31").style.fill = '#ffffff';
                // teeths = arrayRemove(teeths, "47")
                tooth_selected="";
                document.getElementById("smile").value = "";
            }
        }
    ...
    function myfunction32() {
        // var n = teeths.includes("48");
        if(tooth_selected==""){
            document.getElementById("Tooth32").style.fill = '#4481eb';
            // teeths.push("48");
            tooth_selected="48";
            document.getElementById("smile").value = "48";
        }
        else{
            if(tooth_selected=="48"){
                document.getElementById("Tooth32").style.fill = '#ffffff';
                // teeths = arrayRemove(teeths, "48")
                tooth_selected="";
                document.getElementById("smile").value = "";
            }
        }
    ...
    function myfunction85() {
        ...
        if(tooth_selected==""){
            document.getElementById("ToothT").style.fill = '#4481eb';
            // teeths.push(18);
            tooth_selected="85";
            document.getElementById("smile1").value = "85";

        }
        else{
            if(tooth_selected=="85"){
                document.getElementById("ToothT").style.fill = '#ffffff';
                // teeths = arrayRemove(teeths, 18)
                tooth_selected="";
    ...
    function myfunction84() {
        ...
        if(tooth_selected==""){
            document.getElementById("ToothS").style.fill = '#4481eb';
            // teeths.push(18);
            tooth_selected="84";
            document.getElementById("smile1").value = "84";

        }
        else{
            if(tooth_selected=="84"){
                document.getElementById("ToothS").style.fill = '#ffffff';
                // teeths = arrayRemove(teeths, 18)
                tooth_selected="";
                document.getElementById("smile1").value = "";
            }
    ...
    function myfunction83() {
        ...
        if(tooth_selected==""){
            document.getElementById("ToothR").style.fill = '#4481eb';
            // teeths.push(18);
            tooth_selected="83";
            document.getElementById("smile1").value = "83";

        }
        else{
            if(tooth_selected=="83"){
                document.getElementById("ToothR").style.fill = '#ffffff';
                // teeths = arrayRemove(teeths, 18)
                tooth_selected="";
                document.getElementById("smile1").value = "";
            }
    ...
    function myfunction82() {
        ...
        if(tooth_selected==""){
            document.getElementById("ToothQ").style.fill = '#4481eb';
            // teeths.push(18);
            tooth_selected="82";
            document.getElementById("smile1").value = "82";

        }
        else{
            if(tooth_selected=="82"){
                document.getElementById("ToothQ").style.fill = '#ffffff';
                // teeths = arrayRemove(teeths, 18)
                tooth_selected="";
                document.getElementById("smile1").value = "";
            }
    ...
    function myfunction81() {
        ...
        if(tooth_selected==""){
            document.getElementById("ToothP").style.fill = '#4481eb';
            // teeths.push(18);
            tooth_selected="81";
            document.getElementById("smile1").value = "81";

        }
        else{
            if(tooth_selected=="81"){
                document.getElementById("ToothP").style.fill = '#ffffff';
                // teeths = arrayRemove(teeths, 18)
                tooth_selected="";
                document.getElementById("smile1").value = "";
            }
    ...
    function myfunction71() {
        ...
        if(tooth_selected==""){
            document.getElementById("ToothO").style.fill = '#4481eb';
            // teeths.push(18);
            tooth_selected="71";
            document.getElementById("smile1").value = "71";

        }
        else{
            if(tooth_selected=="71"){
                document.getElementById("ToothO").style.fill = '#ffffff';
                // teeths = arrayRemove(teeths, 18)
                tooth_selected="";
                document.getElementById("smile1").value = "";
            }
    ...
    function myfunction72() {
        ...
        if(tooth_selected==""){
            document.getElementById("ToothN").style.fill = '#4481eb';
            // teeths.push(18);
            tooth_selected="72";
            document.getElementById("smile1").value = "72";

        }
        else{
            if(tooth_selected=="72"){
                document.getElementById("ToothN").style.fill = '#ffffff';
                // teeths = arrayRemove(teeths, 18)
                tooth_selected="";
                document.getElementById("smile1").value = "";
            }
    ...
    function myfunction73() {
        ...
        if(tooth_selected==""){
            document.getElementById("ToothM").style.fill = '#4481eb';
            // teeths.push(18);
            tooth_selected="73";
            document.getElementById("smile1").value = "73";

        }
        else{
            if(tooth_selected=="73"){
                document.getElementById("ToothM").style.fill = '#ffffff';
                // teeths = arrayRemove(teeths, 18)
                tooth_selected="";
                document.getElementById("smile1").value = "";
            }
    ...
    function myfunction74() {
        ...
        if(tooth_selected==""){
            document.getElementById("ToothL").style.fill = '#4481eb';
            // teeths.push(18);
            tooth_selected="74";
            document.getElementById("smile1").value = "74";

        }
        else{
            if(tooth_selected=="74"){
                document.getElementById("ToothL").style.fill = '#ffffff';
                // teeths = arrayRemove(teeths, 18)
                tooth_selected="";
                document.getElementById("smile1").value = "";
            }
    ...
    function myfunction75() {
        ...
        if(tooth_selected==""){
            document.getElementById("ToothK").style.fill = '#4481eb';
            // teeths.push(18);
            tooth_selected="75";
            document.getElementById("smile1").value = "75";

        }
        else{
            if(tooth_selected=="75"){
                document.getElementById("ToothK").style.fill = '#ffffff';
                // teeths = arrayRemove(teeths, 18)
                tooth_selected="";
                document.getElementById("smile1").value = "";
            }
    ...
    function myfunction65() {
        ...
        if(tooth_selected==""){
            document.getElementById("ToothJ").style.fill = '#4481eb';
            // teeths.push(18);
            tooth_selected="65";
            document.getElementById("smile1").value = "65";

        }
        else{
            if(tooth_selected=="65"){
                document.getElementById("ToothJ").style.fill = '#ffffff';
                // teeths = arrayRemove(teeths, 18)
                tooth_selected="";
                document.getElementById("smile1").value = "";
            }
    ...
    function myfunction64() {
        ...
        if(tooth_selected==""){
            document.getElementById("ToothI").style.fill = '#4481eb';
            // teeths.push(18);
            tooth_selected="64";
            document.getElementById("smile1").value = "64";

        }
        else{
            if(tooth_selected=="64"){
                document.getElementById("ToothI").style.fill = '#ffffff';
                // teeths = arrayRemove(teeths, 18)
                tooth_selected="";
                document.getElementById("smile1").value = "";
            }
    ...
    function myfunction63() {
        ...
        if(tooth_selected==""){
            document.getElementById("ToothH").style.fill = '#4481eb';
            // teeths.push(18);
            tooth_selected="63";
            document.getElementById("smile1").value = "63";

        }
        else{
            if(tooth_selected=="63"){
                document.getElementById("ToothH").style.fill = '#ffffff';
                // teeths = arrayRemove(teeths, 18)
                tooth_selected="";
                document.getElementById("smile1").value = "";
            }
    ...
    function myfunction62() {
        ...
        if(tooth_selected==""){
            document.getElementById("ToothG").style.fill = '#4481eb';
            // teeths.push(18);
            tooth_selected="62";
            document.getElementById("smile1").value = "62";

        }
        else{
            if(tooth_selected=="62"){
                document.getElementById("ToothG").style.fill = '#ffffff';
                // teeths = arrayRemove(teeths, 18)
                tooth_selected="";
                document.getElementById("smile1").value = "";
            }
    ...
    function myfunction61() {
        ...
        if(tooth_selected==""){
            document.getElementById("ToothF").style.fill = '#4481eb';
            // teeths.push(18);
            tooth_selected="61";
            document.getElementById("smile1").value = "61";

        }
        else{
            if(tooth_selected=="61"){
                document.getElementById("ToothF").style.fill = '#ffffff';
                // teeths = arrayRemove(teeths, 18)
                tooth_selected="";
                document.getElementById("smile1").value = "";
            }
    ...
    function myfunction51() {
        ...
        if(tooth_selected==""){
            document.getElementById("ToothE").style.fill = '#4481eb';
            // teeths.push(18);
            tooth_selected="51";
            document.getElementById("smile1").value = "51";

        }
        else{
            if(tooth_selected=="51"){
                document.getElementById("ToothE").style.fill = '#ffffff';
                // teeths = arrayRemove(teeths, 18)
                tooth_selected="";
                document.getElementById("smile1").value = "";
            }
    ...
    function myfunction52() {
        ...
        if(tooth_selected==""){
            document.getElementById("ToothD").style.fill = '#4481eb';
            // teeths.push(18);
            tooth_selected="52";
            document.getElementById("smile1").value = "52";

        }
        else{
            if(tooth_selected=="52"){
                document.getElementById("ToothD").style.fill = '#ffffff';
                // teeths = arrayRemove(teeths, 18)
                tooth_selected="";
                document.getElementById("smile1").value = "";
            }
    ...
    function myfunction53() {
        ...
        if(tooth_selected==""){
            document.getElementById("ToothC").style.fill = '#4481eb';
            // teeths.push(18);
            tooth_selected="53";
            document.getElementById("smile1").value = "53";

        }
        else{
            if(tooth_selected=="53"){
                document.getElementById("ToothC").style.fill = '#ffffff';
                // teeths = arrayRemove(teeths, 18)
                tooth_selected="";
                document.getElementById("smile1").value = "";
            }
    ...
    function myfunction54() {
        ...
        if(tooth_selected==""){
            document.getElementById("ToothB").style.fill = '#4481eb';
            // teeths.push(18);
            tooth_selected="54";
            document.getElementById("smile1").value = "54";

        }
        else{
            if(tooth_selected=="54"){
                document.getElementById("ToothB").style.fill = '#ffffff';
                // teeths = arrayRemove(teeths, 18)
                tooth_selected="";
                document.getElementById("smile1").value = "";
            }
    ...
    function myfunction55() {
        ...
        if(tooth_selected==""){
            document.getElementById("ToothA").style.fill = '#4481eb';
            // teeths.push(18);
            tooth_selected="55";
            document.getElementById("smile1").value = "55";

        }
        else{
            if(tooth_selected=="55"){
                document.getElementById("ToothA").style.fill = '#ffffff';
                // teeths = arrayRemove(teeths, 18)
                tooth_selected="";
                document.getElementById("smile1").value = "";
            }
    ...
    //         var aa="";
    //         if(data[i]==18 || data[i]=="28" || data[i]=="38" || data[i]=="48"){
    //             aa="3rd Molar"; 
    //         }
    //         else if(data[i]=="17" || data[i]=="27" || data[i]=="37" || data[i]=="47"){
    //             aa="2nd Molar";
    //         }
    //         else if(data[i]=="16" || data[i]=="26" || data[i]=="36" || data[i]=="46"){
    //             aa="1st Molar";
    //         }
    //         else if(data[i]=="15" || data[i]=="25" || data[i]=="35" || data[i]=="45"){
    //             aa="2nd Bicuspid";
    //         }
    //         else if(data[i]=="14" || data[i]=="24" || data[i]=="34" || data[i]=="44"){
    //             aa="1st Bicuspid";
    //         }
    //         else if(data[i]=="13" || data[i]=="23" || data[i]=="33" || data[i]=="43"){
    //             aa="Cuspid";
    //         } 
    //         else if(data[i]=="12" || data[i]=="22" || data[i]=="32" || data[i]=="42"){
    //             aa="Lateral incisor";
    //         }
    //         else{
    //             aa="Central incisor";
    ...
    //         var row=`<tr>
    //                     <td><input class="form-control" type="text" name="tooth_number" value="${data[i]}" style="border:none;" /></td>
    //                     <td>
    
    //                         <input class="form-control" type="text" name="tooth_name" value="${aa}" style="border:none;" />
    ...
    $(document).ready(function() {
        $('.edit_btn').click(function (e) {
            e.preventDefault();
            var tooth_send = $(this).closest("div").find('.tooth_sendd').val();
            // var edit_givenwork = $(this).closest("div").find('.edit2').val();
            
            // console.log(tooth_send);
            if(tooth_send!=""){
                $.ajax({
                    url: "check.php",
                    method: "post",
                    data: { 
                        tooth_send: tooth_send
                    },
                    success: function(data) {
                        swal("Tooth Added Successfully.!", {
                            icon: "success",
                        }).then((result) => {
                            location.reload();
                        });
        ...
        $(document).ready(function () {
            ...
            $('.delete_btn1_ajax').click(function (e) {
                e.preventDefault();
                    ...
                    swal({
                        title: "Are you sure?",
                        text: "Once deleted, you will not be able to recover Tooth!",
                        icon: "warning",
                    ...
                    if (willDelete) {
                            $.ajax({
                                ...
                                success: function (response) {
                                    swal("Tooth Deleted Successfully.!", {
                                        icon: "success",
                                    }).then((result) => {
                                        location.reload();
                                    });
    ...
    <!-- <script>
        ...
        $(document).ready(function(){
            $('#save').click(function(){
                ...
                // $('.tooth_number').each(function(){
                //     teeth_numbers.push($(this).text());
                // });
                // $('.tooth_name').each(function(){
                //     teeth_names.push($(this).text());
                // });
                // var tee = $(this).closest("div").find('.ee').val();

                console.log(teeths);
                // $.ajax({
                //     url:"submit_p_dental_chart.php",
                //     method:"POST",
                //     data:{
                //         "teeths":teeths 
                //         // "teeth_names":teeth_names, 
                //         },
                //     success:function(data){
                //             console.log("yess" );
                      
                //         // swal("Dental Chart Added Successfully.!", {
                //         //     icon: "success",
                //         // }).then((result) => {
                //         //     location.reload();
                //         // });
