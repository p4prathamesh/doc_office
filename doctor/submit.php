...
$state = $_POST['state'];
$pin = $_POST['pin'];
$saved_by = $_POST['eemail'];

if(!$con){
    die("connection failed " . mysqli_connect_error());
}
else{
    $sql = "insert into patients(opd,first_name,last_name,dob,gender,age,mobile,o_mobile,add_1,add_2,city,state,pin,date,saved_by,edited_by) VALUES ('$opdno','$f_name','$l_name','$dob','$gender','$age','$mobile','$o_mobile','$add_1','$add_2','$city','$state','$pin','$today','$saved_by','')";
